                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-9">
                            <section class="content-body p-xl-4">
                                ...
                                <div class="mb-4">
                                    {!! Form::label('ingredient', 'Varietas', ['class' => 'form-label']) !!}
                                    {!! Form::select('ingredient_id', $ingredients, !empty($product) ? $ingredientID : null, ['class' => 'form-control', 'placeholder' => '-- Pilih Bahan --']) !!}
                                </div>
                                <div class="mb-4">
