                            ...
                            <div class="login_wrap widget-taber-content background-white">
                                <div class="padding_eight_all bg-white">
                                    <div class="heading_s1">
                                        ...
                                        <p class="mb-30">Belum punya akun? <a href="{{ url('register') }}">Daftar disini</a></p>
                                    </div>
                                    <form method="post" {{ route('login') }}>
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" required="" name="email" class="@error('email') is-invalid @enderror"  placeholder="Username or Email *" autocomplete="off" />
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <input required="" type="password" name="password" class="@error('password') is-invalid @enderror" placeholder="Your password *" autocomplete="off" />
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
