                    ...
                    <div class="col-lg-12">
                        <div class="invoice-inner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6  text-end">
                                            <div class="invoice-numb">
                                                <h4 class="invoice-header-1 mb-10 mt-20">Invoice No: <span class="text-heading">#{{ $order->code }}</span></h4>
                                                <h6>Invoice Date:  <span class="text-heading">{{ \General::datetimeFormat($order->order_date) }}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="invoice-number">
                                                ...
                                                <p class="invoice-addr-1">
                                                    ...
                                                    <abbr title="Phone">Phone:</abbr> {{ $order->customer_phone }}<br>
                                                    <abbr title="Email">Email: </abbr>{{ $order->customer_email }}<br>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="invoice-number">
                                                ...
                                                <p class="invoice-addr-1">
                                                    <strong>Invoice Data:</strong> {{ \General::datetimeFormat($order->order_date) }}<br />
                                                    <strong>Due Data:</strong> {{ $order->payment_due }}<br />
                                                    <strong>Payment Status:</strong> {{ $order->payment_status }}<br />
                                                     <strong>Status:</strong> <span class="text-brand">{{ $order->status }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-striped invoice-table">
                                            ...
                                            @forelse ($order->orderItems as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ \General::priceFormat($item->base_price) }}</td>
                                                    <td class="text-center">{{ $item->qty }}</td>
                                                    <td class="text-right">{{ \General::priceFormat($item->sub_total) }}</td>
                                                </tr>
                                                @empty
									<tr>
										<td colspan="4">Order item not found!</td>
									</tr>
								@endforelse
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ \General::priceFormat($order->base_total_price) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" class="text-end f-w-600">Tax</td>
                                                    <td class="text-right">{{ \General::priceFormat($order->tax_amount) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" class="text-end f-w-600">Grand Total</td>
                                                    <td class="text-right f-w-600">{{ \General::priceFormat($order->grand_total) }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="invoice-bottom">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-offsite">
                                            ...
                                            <h3 class="mt-0 mb-0 text-brand">{{ \General::priceFormat($order->grand_total) }}</h3>
                                            ...
                                            <br>
                                                ...
                                                <div class="mobile-social-icon mt-30 print-hide">
                                                    <h6>Follow Us</h6>
                            ...
                            <div class="invoice-btn-section clearfix d-print-none">
                                ...
                                @if (!$order->isPaid())
                                <a href="{{ $order->payment_url }}" class="btn btn-lg btn-custom btn-download hover-up"> <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-download.svg') }}" alt="" /> Download </a>
                                @endif
